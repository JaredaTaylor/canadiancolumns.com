...
const testimonialsData = [
  ...
  { quote: "I am extremely happy with the quality of work provided. Although I was not home during the column replacement, I had full confidence it would be done right—and it absolutely was. The attention to detail was clear, from the clean caulking to the spotless job site. The finished result has really improved our homes curb appeal. I would not hesitate to recommend this company to others. Thank you again!", name: "Brendan Slute"}
];
