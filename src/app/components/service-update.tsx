    ...
    return (
        <section id="service-update" className="py-20 bg-gray-50">
            <div className="container mx-auto lg:px-20 px-6">
                <h2 className="text-2xl font-semibold mb-4 text-center">Fiberglass Column Replacement Services Now Available Across the Greater Toronto Area</h2>
                <h3 className="text-xl font-semibold mb-4 text-center">Now Serving Markham, Mississauga, London & More</h3>
